...
class AboutIteration(Koan):
    ...
    def test_iterators_are_a_type(self):
        ...
        self.assertEqual(15, fib) #1 + 2 + 3 + 4 + 5
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        result3 = reduce(self.multiply, [2, 3, 4], 10)
        self.assertEqual(24, result2) # (2*1) * (3*4)
        self.assertEqual(240, result3) # (2*10) * (3*3)

        # Extra Credit:
        # Describe in your own words what reduce does.

        # At each step, reduce passes the current value, along with the next item from the list
    # ------------------------------------------------------------------
