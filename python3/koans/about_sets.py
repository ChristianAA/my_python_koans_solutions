...
class AboutSets(Koan):
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie'}, scotsmen - warriors) 	# (s - t) new set with elements in s but not in t
        self.assertEqual({'MacLeod', 'Wallace', 'Willie','Leonidas'}, scotsmen | warriors) # (s | t) new set with elements from both s and t
        self.assertEqual({'MacLeod', 'Wallace'}, scotsmen & warriors) # (s & t) new set with elements common to s and t
        self.assertEqual({'Willie','Leonidas'}, scotsmen ^ warriors) # (s ^ t) 	new set with elements in either s or t but not both
